function [VarName1,VarName2,VarName3] = importfile1(filename, startRow, endRow)
%IMPORTFILE1 将文本文件中的数值数据作为列矢量导入。
%   [VARNAME1,VARNAME2,VARNAME3] = IMPORTFILE1(FILENAME) 读取文本文件 FILENAME
%   中默认选定范围的数据。
%
%   [VARNAME1,VARNAME2,VARNAME3] = IMPORTFILE1(FILENAME, STARTROW, ENDROW)
%   读取文本文件 FILENAME 的 STARTROW 行到 ENDROW 行中的数据。
%
% Example:
%   [VarName1,VarName2,VarName3] = importfile1('graph.txt',2, 25572);
%
%    另请参阅 TEXTSCAN。

% 由 MATLAB 自动生成于 2018/01/08 15:17:40
